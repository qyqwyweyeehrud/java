...
public class SetEx extends JFrame {//List와 제이프레임은 is a관계이다 /엄마도 김 아빠도 김 이면 자식도 김이기 때문에 ListEx도 김씨이다
		...
		if (btnNewButton_2 == null) {
			...
			btnNewButton_2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					while(iter.hasNext()) {
						String d = iter.next();
						if(d.indexOf(find)>=0||find.equals("")) {//indexof는 같은게 하나라도 있느면 1을 리턴, 없다면 -1 을 리턴
