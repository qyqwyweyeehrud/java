...
public class MemberSearch extends JInternalFrame {
	 ...
	 */
	public MemberSearch() {
		super("È¸¿øÁ¶È¸",false,true,true,true);
	...
	public void search() {
		...
		for(int i =0 ;i<list.size();i++) {
			MemberVo vo = list.get(i);//¸â¹öºêÀÌ¿À Å¸ÀÔ ÀÇ ºêÀÌ¿À
	...
	public JTextField getFindstr() {
		if (findstr == null) {
			...
			findstr.setFont(new Font("³ª´®°íµñ", Font.PLAIN, 12));
	...
	private JTextArea getTextArea() {
		if (textArea == null) {
			...
			textArea.setFont(new Font("³ª´®°íµñ", Font.PLAIN, 13));
		}
		return textArea;
	}
}
