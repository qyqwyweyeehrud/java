...
public class BankApp extends JFrame {//단일상속 = class와 class사이의 상속의 부모는 단 하나만존재한다
	...
	private JMenuItem getMntmNewMenuItem() {
		if (mntmNewMenuItem == null) {
			mntmNewMenuItem = new JMenuItem("\uACC4\uC815\uC0DD\uC131");//계좌생성
			mntmNewMenuItem.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {//마우스를 클릭하면 이부분이 실행됨
	...
	private JMenuItem getMntmNewMenuItem_4() {
		if (mntmNewMenuItem_4 == null) {
			...
			mntmNewMenuItem_4.addActionListener(new ActionListener() {//Listener가 붙어있으면 무조건 인터페이스 , 즉 깡통
				public void actionPerformed(ActionEvent e) {
					contentPane.removeAll();
